...
* FSM Design, Datapath & Control Unit Design
* Pipelined Architecture (5-stage RISC-V - in progress)
* Hazard Detection & Forwarding (learning phase)

### ⚡ SoC & Embedded Systems

* RISC-V Architecture (Custom + SHAKTI SoC)
* Peripheral Integration (UART, GPIO, Memory Interfaces)
* On-chip Communication (Wishbone - in progress)
...
* 🏁 Smart India Hackathon 2025 – Hardware Edition Hackathon(Team Leader) 
* 🛠️ Grand Finale Qualifier (Top 100), MeitY Chip2Startup Grand Challenge (Team Leader)
* 💡 Multiple FPGA + Embedded System Projects
